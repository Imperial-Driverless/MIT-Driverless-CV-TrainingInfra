...
from CVC_YOLOv3.utils.utils import xywh2xyxy, calculate_padding
...
class YOLO_N():
    ...
    def __init__(
        self,
        weights_path="yolo_weights/pretrained_yolo.weights", #"CVC_YOLOv3/yolo_weights/pretrained_yolo.weights",
        model_cfg="model_cfg/yolo_baseline.cfg", #"CVC_YOLOv3/model_cfg/yolo_baseline.cfg",
        conf_thres=0.8,
        nms_thres=0.25,
        xy_loss=2,
        wh_loss=1.6,
